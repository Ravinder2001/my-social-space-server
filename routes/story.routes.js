...
const { Add_Story, Delete_Story, Get_All_Story, Find_Story_By_UserId } = require("../controllers/story.controller");
...
router.get("/single/:user_id", authentication, Find_Story_By_UserId);
